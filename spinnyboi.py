...
theta_spacing = 0.05  # Decreased theta spacing for higher resolution
phi_spacing = 0.03    # Decreased phi spacing for higher resolution
R1 = 1
R2 = 2
K2 = 5
...
def main():
    ...
    while True:
        ...
        A += 0.09  # Adjust increment values to control rotation speed
        B += 0.09  # Adjust increment values to control rotation speed
